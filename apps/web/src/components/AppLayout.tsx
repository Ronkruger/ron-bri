  ...
  return (
    <div className="flex min-h-screen">
      ...
      <button
        ...
        className="fixed bottom-20 md:bottom-24 left-4 md:left-auto md:right-6 z-50 w-12 h-12 md:w-14 md:h-14 rounded-full bg-[var(--color-primary)] text-white text-xl md:text-2xl shadow-lg hover:scale-110 active:scale-95 transition-transform flex items-center justify-center"

  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] md:h-screen">
      ...
      <div className="flex-1 p-6 overflow-hidden">
        ...
        <div className="h-[calc(100%-4rem)] bg-white/50 backdrop-blur-sm rounded-3xl shadow-sm border border-white/60 p-4">
          <Calendar
            localizer={localizer}
      ...
      <AnimatePresence>
        {panelEvent && (
          <motion.aside
            ...
            className="w-80 bg-white/60 backdrop-blur-md shadow-xl border-l border-white/40 p-6 flex flex-col gap-4 overflow-y-auto"
          >
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white/70 backdrop-blur-sm rounded-4xl w-full max-w-md p-8 shadow-2xl border border-white/50"
        >
